 ...
 * shebang wrapper, and fuzz-smoke.sh checks the ELF magic). bitstring is a pure-Python
 * binary-data library (with bitarray/tibs C backings installed as ordinary wheels), so
...
#ifndef PY_SCRIPT
#define PY_SCRIPT "/mayhem/mayhem/fuzz_bit.py"
#endif
